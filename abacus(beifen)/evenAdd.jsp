...
<div class="box">
    ...
    <div id="title">
        <div class="topicBox">
            <div id="topic" class="topic">
                ...
                <h1>请计算 <span id="num1"></span> 连加 30 次的结果</h1>
    ...
    <div id="result" class="result">
        <h1 style="margin: 0px">这题答案为：<span id="answerA"></span></h1>
        ...
        <div style="margin: 0px"><h1 style="margin: 0px">您的答案为：<spam id="answerB"></spam></h1></div>
...
<script>
    $(function () {
        ...
        function post_result() {
            ...
            opes_result_data.commentset = "请计算"+level+"连加 30 次的结果";
