...
<OPES_Task> ots=OPES_TaskDAO.getOPES_aTask(Integer.parseInt(request.getParameter("taskid")),lan);
    ...
    <!--<script src="carry_and_abate.js"></script>-->
    <script>
        $(function () {
            var digit="4";
            var pens="3";
            ...
            function taskidFun(taskid) {
                if(taskid == "5579" || taskid == "5580"){
                    digit="1";

                }else if(taskid == "5581" || taskid == "5582"){
                    digit="2";
                }else if(taskid == "5583" || taskid == "5584"){
                    digit="3";
                }else if(taskid == "5559" || taskid == "5519"){
                    digit="4";
                }
