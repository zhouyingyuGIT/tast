        ...
        $(function () {
            ...
            function pensFun(pens) {
                ...
                if(pens == "3"){
                    ...
                    setTimeout(function(){ fayin(num2,speed); }, t);
                    //
                    setTimeout(function(){ fayin("减"+num3,speed); }, t*2);
                    ...
                    setTimeout(function(){ fayin(num2,speed); }, t);
                    //
                    setTimeout(function(){ fayin(num3,speed); }, t*2);

                    setTimeout(function(){ fayin("减"+num4,speed); }, t*3);
                    ...
                    setTimeout(function(){ fayin(num4,speed); }, t*3);

                    setTimeout(function(){ fayin(num5,speed); }, t*4);
                    ...
                    setTimeout(function(){ fayin("减"+num6,speed); }, t*5);
                    arrT.push(num1);
                    arrT.push(num2);
                    arrT.push(-num3);
                    arrT.push(num4);
                    ...
                    setTimeout(function(){ fayin(num7,speed); }, t*6);
