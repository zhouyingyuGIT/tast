...
<script>
    $(function () {
        ...
        function taskidFun(taskid) {
            if(taskid == "5569" || taskid == "5570"){
                digit="1";

            }else if(taskid == "5571" || taskid == "5572"){
                digit="2";
            }
        ...
        function pensFun(pens) {
            ...
            if(pens == "3"){
                ...
                setTimeout(function(){ fayin("减"+num5,speed); }, t*4);
                ...
                setTimeout(function(){ fayin(num6,speed); }, t*5);
                ...
                setTimeout(function(){ fayin("减"+num7,speed); }, t*6);
