...
<div class="box">
    <div id="title">
        <div class="topicBox">
            <div id="topic" class="topic">
                ...
                <h1>请计算 5050-1-2-3 直至结果为0</h1>

                <h4 id="ti" style="color: #555">准备好了吗？准备好了就点击开始计时</h4>

                <div style="margin-top: 100px;text-align: center;width: 100%">
                    <input onkeyup="this.value=this.value.replace(/\D/g,'')" id="inputAnswer" type="text" placeholder="请输入您的最后一个减数">
                </div>
            </div>
    ...
    <div id="result" class="result">
        <h1 style="margin: 0px">这题答案为：<span id="answerA">100</span></h1>
        ...
        <h1 style="margin: 0px">您本次用时 <spam id="answerTime"></spam>秒</h1>
...
<script>
    $(function () {
        ...
        function post_result() {
            ...
            opes_result_data.correctanswerset = "100";
            ...
            opes_result_data.commentset = "请计算 5050-1-2-3 直至结果为0";
...
<!--<script src="reduceNum.js"></script>-->
</html>