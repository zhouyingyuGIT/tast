...
<div class="box">
    ...
    <div id="titleBox" class="boxMix titleBox">
        ...
        <h2 style="text-align: center">请选出与下图最接近的数</h2>

        <div style="width: 80%;margin: 16px auto 0px;" class="clearfix">
        ...
        <div style="width: 60%;margin: 0px auto" class="clearfix">
            <div id="Qkey" style="width: 50%;float: left;font-weight: 700;font-size: 38px;line-height: 100px;text-align: center">
                <div id="dui"></div>
                <div>Q键</div>
            </div>
            <div id="Pkey" style="width: 50%;float: right;font-weight: 700;font-size: 38px;line-height: 100px;text-align: center">
                <div id="cuo"></div>
                <div>P键</div>
            </div>
        </div>
...
<!--<script src="pearls_of_number.js"></script>-->
<script>
    $(function(){
        var level="2";
        var num;
