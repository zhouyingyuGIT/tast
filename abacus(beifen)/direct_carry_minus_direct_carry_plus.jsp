...
<OPES_Task> ots=OPES_TaskDAO.getOPES_aTask(Integer.parseInt(request.getParameter("taskid")),lan);
    ...
    <div class="box">
        ...
        <div id="step1" class="step step1">
            <h1 style="margin: 0px">直接进位加，退位直接减</h1>
            <!--digit-->
            <div class="levelBox">
    ...
    <script>
        $(function () {
            ...
            function taskidFun(taskid) {
                if(taskid == "5521" || taskid == "5551"){
                    digit="1";

                }else if(taskid == "5522" || taskid == "5552"){
                    digit="2";
                }else if(taskid == "5523" || taskid == "5553"){
                    digit="3";
                }else if(taskid == "5524" || taskid == "5554"){
                    digit="4";
                }
            ...
            function additionFun(data) {
                ...
                for (var i = dl; i>=0; i--) {
                    if (arr1[i] == "1") {
                        ...
                        var numArr4 = [3,4,5,8,9];
                        numA += (numArr4[Math.floor(Math.random() * numArr4.length)]).toString();
                        continue;
                    } else if (arr1[i] == "8") {
                        var numArr4 = [2,3,4,5,7,8,9];
                        numA += (numArr4[Math.floor(Math.random() * numArr4.length)]).toString();
                        continue;
                    } else if (arr1[i] == "9") {
                        var numArr4 = [1,2,3,4,5,6,7,8,9];
                        numA += (numArr4[Math.floor(Math.random() * numArr4.length)]).toString();
                        continue;
                    }else if (arr1[i] == "0") {
                        var numArr4 = [1,2,3,4];
