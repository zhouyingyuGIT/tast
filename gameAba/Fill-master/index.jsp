...
<div id="tir" style="color: #ff0000;position: fixed;top: 0px;width: 500px;height: 100px"></div>
	<!--<div id='topdiv'>
		<img src="fill_logo.png" id='logo'>
	</div>-->

	<div id='leftdiv'>
		<div id='controlsdiv'>
			<div class='textbox'>&uarr; .....上</div>
			<div class='textbox'>&larr; .....左</div>
			<div class='textbox'>&darr; .....下</div>
			<div class='textbox'>&rarr; .....右</div>
			<div class='textbox'>r ...重置</div>
			<!--<div class='textbox'>t .. theme</div>-->
			<!--<div class='textbox'>z ... prev</div>-->
			<!--<div class='textbox'>x ... next</div>-->
		</div>
	</div>
	
	<canvas id='gameboard' width='330px' height='330px'>
		If you can see this, your browser doesn't support the canvas element :(
	</canvas>
	<canvas id='offscreen_canvas' width='330px' height='330px'>
	</canvas>
	
	<div id='rightdiv'>
		<div id='leveldiv'>
			<p id='levelcounter'>Loading...</p> <!-- This should get replaced by the code -->
		</div>
	</div>
	...
	<!-- My scripts -->
	<script src='js/mousetrap-1.4.6.min.js'></script>
	...
	<script>
        ...
        function animateWin()
        {
            ...
            ++level_num;
            type4set.push(level_num);
            numset.push(level_num);
