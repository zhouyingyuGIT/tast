...
<div class="lfBox">
    ...
    <div class="step" id="step2">
        <div style="font-size: 24px;font-weight: 700;padding: 16px;text-align: center">请选出与数字<span id="numR" style="color: #ff0000"></span>大小最接近的珠像图</div>
