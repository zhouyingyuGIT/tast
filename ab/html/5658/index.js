...
// 生成数
    ...
    function fcFun(topicTypes) {
        if(topicTypes ==1 || topicTypes ==2 || topicTypes ==6 || topicTypes ==7){
            $("#fc1").css({
                display: block
            });
            $("#fc2").css({
        ...
        }else if(topicTypes ==3 || topicTypes ==8){
            $("#fc1").css({
                display: block
            });
            $("#fc2").css({
        ...
        }else if(topicTypes ==4 || topicTypes ==5 || topicTypes ==9){
            $("#fc1").css({
                display: block
            });
            $("#fc2").css({
