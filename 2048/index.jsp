...
<body>
	...
	<script>
        ...
        function post_result() {
            ...
            ///////////////////////////////////////////////////////////////////
            //以下判断总题数
            opes_result_data.type4set = "123";
            opes_result_data.stimidset = "1";
            opes_result_data.correctanswerset = "21312";
            opes_result_data.time = timer;
            opes_result_data.level = sd.blankNum;

            opes_result_data.timeset = "123213";
            opes_result_data.radioset = "12";
            opes_result_data.buttonset = "21";
            opes_result_data.commentset = "23456788";
            console.log(opes_result_data);
            opes_result_data.numset = Math.sqrt(3600-opes_result_data.time)*opes_result_data.level;
            console.log(opes_result_data);
